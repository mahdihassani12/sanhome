jQuery(document).ready(function ($) {
    ...
    $(".package_form").on('click', function (event) {

        event.preventDefault();
        var data = {
            action: 'add_package_user',
            user_id: $(this).attr("user_id"),
            vip_properties: $(this).attr("vip"),
            normal_properties: $(this).attr("normal"),
            golden_properties: $(this).attr("golden"),
            post_id: $(this).parent().parent().attr("id"),
        };

        $(this).val("در حال انجام...");
