			...
			if ( ( is_user_logged_in() && 'yes' == $require_login ) || ( 'yes' != $require_login ) ) {
				...
				if ( is_added_to_favorite( $property_id ) ) {
					...
					if ( $single ) {
                            ...
                            <span class="rh_tooltip">
                                <p class="label">
                                     ...
                                     if ( $inspiry_added_to_fav_property_label ) {
	                                     ...
	                                     esc_html_e( 'Added to Favorite', 'easy-real-estate' );
                                     }
                                     ?>
                                </p>
                            </span>
						...
						?>
                        <span class="favorite-placeholder highlight__red" data-tooltip="<?php esc_attr_e( 'Added to favorites', 'easy-real-estate' ); ?>">
                            <?php include INSPIRY_THEME_DIR . '/images/icons/icon-favorite.svg'; ?>
                        </span>
						<?php
					}
					...
					if ( $single ) {
                            ...
                            <span class="rh_tooltip">
                                <p class="label">
                                    ...
                                    if ( $inspiry_add_to_fav_property_label ) {
	                                    ...
	                                    esc_html_e( 'Favorite', 'easy-real-estate' );
                                    }
                                    ?>
                                </p>
                            </span>
                        ...
                        <span class="favorite-placeholder highlight__red hide"
                              data-tooltip="<?php esc_attr_e( 'اضافیه شد به لیست علاقمندان', 'easy-real-estate' ); ?>">
                            <?php include INSPIRY_THEME_DIR . '/images/icons/icon-favorite.svg'; ?>
                        </span>
                        <a href="#" class="favorite add-to-favorite"
                           data-tooltip="<?php esc_attr_e( 'اضافیه به لیست علاقمندان', 'easy-real-estate' ); ?>">
							<?php include INSPIRY_THEME_DIR . '/images/icons/icon-favorite.svg'; ?>
                        </a>
						<?php
					}
				...
				if ( $display_button ) {
					if ( $single ) {
                        ...
                        <a href="#" class="favorite add-to-favorite require-login"
                           data-tooltip="<?php esc_attr_e( 'Add to favorites', 'easy-real-estate' ); ?>"
