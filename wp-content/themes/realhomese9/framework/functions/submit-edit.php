                    ...
                    <div class="inspiry-row">
                        <div class="inspiry-column-md-6">
                            <div class="inspiry-field">
                                <label for="inspiry_floor_plan_name_<?php echo esc_attr( $key ); ?>"><?php esc_html_e('نام طبقه', 'easy-real-estate'); ?></label>
                            ...
                            <div class="inspiry-field">
                                <label for="inspiry_floor_plan_descr_<?php echo esc_attr( $key ); ?>"><?php esc_html_e('توضیحات', 'easy-real-estate'); ?></label>
                        ...
                        <div class="inspiry-column-md-6">
                            <div class="inspiry-row">
                                <div class="inspiry-column-6">
                                    <div class="inspiry-field">
                                        <label for="inspiry_floor_plan_price_<?php echo esc_attr( $key ); ?>"><?php esc_html_e('قمیت طبقه ( فقط عدد )', 'easy-real-estate'); ?></label>
                                ...
                                <div class="inspiry-column-6">
                                    <div class="inspiry-field">
                                        <label for="inspiry_floor_plan_price_postfix"><?php esc_html_e('Price Postfix', 'easy-real-estate'); ?></label>
                                ...
                                <div class="inspiry-column-6">
                                    <div class="inspiry-field">
                                        <label for="inspiry_floor_plan_size_<?php echo esc_attr( $key ); ?>"><?php esc_html_e(' مساحت ( فقط عدد )', 'easy-real-estate'); ?></label>
                                ...
                                <div class="inspiry-column-6">
                                    <div class="inspiry-field">
                                        <label for="inspiry_floor_plan_size_postfix_<?php echo esc_attr( $key ); ?>"><?php esc_html_e('پسوند مساحت', 'easy-real-estate'); ?></label>
                                ...
                                <div class="inspiry-column-6">
                                    <div class="inspiry-field">
                                        <label for="inspiry_floor_plan_bedrooms_<?php echo esc_attr( $key ); ?>"><?php esc_html_e('Bedrooms', 'easy-real-estate'); ?></label>
                                ...
                                <div class="inspiry-column-6">
                                    <div class="inspiry-field">
                                        <label for="inspiry_floor_plan_bathrooms_<?php echo esc_attr( $key ); ?>"><?php esc_html_e('Bathrooms', 'easy-real-estate'); ?></label>
                                ...
                                <div class="inspiry-column-12">
                                    <div class="inspiry-field inspiry-file-input-wrapper">
                                        <label><?php esc_html_e('عکس طبقه', 'easy-real-estate'); ?></label>
	                                    <?php
                                        ...
                                        <div class="inspiry-btn-group clearfix <?php echo esc_attr( $inspiry_show_remove_btn ); ?>">
                                            ...
                                            <a href="#" id="inspiry-file-select-<?php echo esc_attr( $key ); ?>" class="inspiry-file-select real-btn"><?php esc_html_e( 'انتخاب عکس', 'easy-real-estate' ); ?></a>
                                            <a href="#" id="inspiry-file-remove-<?php echo esc_attr( $key ); ?>" class="inspiry-file-remove real-btn <?php echo esc_attr( $inspiry_file_remove_button_class ); ?>"><?php esc_html_e( 'پاک کردن', 'easy-real-estate' ); ?></a>
                                        </div>
                                        <p class="description"><?php esc_html_e('پشنهاد میشود که770px باشد.', 'easy-real-estate'); ?></p>
		...
		<?php else : ?>
            <div class="inspiry-clone inspiry-group-clone" data-floor-plan="0">
                <div class="inspiry-row">
                    <div class="inspiry-column-md-6">
                        <div class="inspiry-field">
                            <label for="inspiry_floor_plan_name_0"><?php esc_html_e('نام طبقه', 'easy-real-estate'); ?></label>
                            <input type="text" id="inspiry_floor_plan_name_0" name="inspiry_floor_plans[0][inspiry_floor_plan_name]">
                        </div>
                        <div class="inspiry-field">
                            <label for="inspiry_floor_plan_descr_0"><?php esc_html_e('توضیحات', 'easy-real-estate'); ?></label>
                            ...
                            <div class="inspiry-column-12">
                                <div class="inspiry-field inspiry-file-input-wrapper">
                                    ...
                                    <div class="inspiry-btn-group clearfix">
                                        ...
                                        <a href="#" id="inspiry-file-select-0" class="inspiry-file-select real-btn"><?php esc_html_e('انتخاب عکس', 'easy-real-estate'); ?></a>
                                        <a href="#" id="inspiry-file-remove-0" class="inspiry-file-remove real-btn hidden"><?php esc_html_e('پاک کردن', 'easy-real-estate'); ?></a>
                                    </div>
                                    <p class="description"><?php esc_html_e('پشنهاد میشود که770px باشد.', 'easy-real-estate'); ?></p>
                                    <div class="errors-log"></div>
                                </div>
...
if ( ! function_exists( 'inspiry_render_floor_plan_group_labels') ) :
	...
	function inspiry_render_floor_plan_group_labels() { ?>
        <div id="floor-plan-group-labels"
             data-name="<?php esc_html_e( 'Floor Name', 'easy-real-estate' ); ?>"
             data-description="<?php esc_html_e( 'Description', 'easy-real-estate' ); ?>"
             data-price="<?php esc_html_e( 'Floor Price ( Only digits )', 'easy-real-estate' ); ?>"
             data-price-postfix="<?php esc_html_e( 'Price Postfix', 'easy-real-estate' ); ?>"
             data-size="<?php esc_html_e( 'Floor Size ( Only digits )', 'easy-real-estate' ); ?>"
             data-size-postfix="<?php esc_html_e( 'Size Postfix', 'easy-real-estate' ); ?>"
             data-bedrooms="<?php esc_html_e( 'Bedrooms', 'easy-real-estate' ); ?>"
             data-bathrooms="<?php esc_html_e( 'Bathrooms', 'easy-real-estate' ); ?>"
             data-image="<?php esc_html_e( 'Floor Plan Image', 'easy-real-estate' ); ?>"
             data-select-button="<?php esc_html_e( 'Select Image', 'easy-real-estate' ); ?>"
             data-remove-button="<?php esc_html_e( 'Remove', 'easy-real-estate' ); ?>"
             data-image-description="<?php esc_html_e( 'The recommended minimum width is 770px and height is flexible.', 'easy-real-estate' ); ?>"></div>
		<?php
	}
endif;
...
if ( ! function_exists( 'inspiry_floor_plans') ) :
	...
	function inspiry_floor_plans() { ?>
        ...
        <div class="form-option inspiry-floor-plans-group-wrapper">
            <label><?php esc_html_e( 'ساختار ساختمان', 'easy-real-estate' ); ?></label>
            ...
            <div class="inspiry-add-clone-container">
                <a href="#" id="inspiry-add-clone" class="inspiry-add-clone"><?php esc_html_e( '+ اضافه کردن', 'easy-real-estate' ); ?></a>
            </div>
