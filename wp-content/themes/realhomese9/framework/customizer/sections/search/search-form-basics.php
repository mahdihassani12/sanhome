...
if ( ! function_exists( 'inspiry_search_form_basics_customizer' ) ) :
	...
	function inspiry_search_form_basics_customizer( WP_Customize_Manager $wp_customize ) {
		...
		/* Search Fields */
			...
			$search_fields = array(
				'keyword-search'    => esc_html__( 'کلید واژه ملک', 'framework' ),
				'property-id'   => esc_html__( 'کد نمبر ملک', 'framework' ),
				'location'      => esc_html__( 'موقعیت ملک', 'framework' ),
				'status'        => esc_html__( 'حالت ملک', 'framework' ),
				'type'          => esc_html__( 'نوعیت ملک', 'framework' ),
				'agent'         => esc_html__( 'نمایده فروش', 'framework' ),
				'min-beds'      => esc_html__( 'کمترین اتاق خواب', 'framework' ),
				'min-baths'     => esc_html__( 'کمترین حمام', 'framework' ),
				'min-max-price' => esc_html__( 'کمترین و بیشترین قمیت ها', 'framework' ),
				'min-max-area'  => esc_html__( 'کمترین و بیشتر مساحت', 'framework' ),
				'min-garages'   => esc_html__( 'تعداد باقچه', 'framework' ),
			);
		...
		$wp_customize->add_setting(
			'inspiry_property_type_label', array(
				'type'              => 'option',
				'transport'         => 'postMessage',
				'default'           => esc_html__( 'نوعیت ملک', 'framework' ),
				'sanitize_callback' => 'sanitize_text_field',
			)
		);
		$wp_customize->add_control(
