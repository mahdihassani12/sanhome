						...
						<?php
							...
							if ( ! empty( $inspiry_contact_form_shortcode ) ) {
								...
								if ( ! empty( $theme_contact_email ) ) {
									...
									$contact_form_name_label    = empty( $name_label ) ? esc_html__( 'Name', 'easy-real-estate' ) : $name_label;
									$contact_form_email_label   = empty( $email_label ) ? esc_html__( 'Email', 'easy-real-estate' ) : $email_label;
									$contact_form_number_label  = empty( $number_label ) ? esc_html__( 'Phone Number', 'easy-real-estate' ) : $number_label;
									$contact_form_message_label = empty( $message_label ) ? esc_html__( 'Message', 'easy-real-estate' ) : $message_label;
									...
									<section id="contact-form">
										<form class="contact-form" method="post" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>">
											<p class="rh_contact__input rh_contact__input_text">
												...
												<input type="text" name="name" id="name" class="required" placeholder="<?php esc_attr_e( 'اسم شما', 'easy-real-estate' ); ?>" title="<?php esc_attr_e( '* Please provide your name', 'easy-real-estate' ); ?>">
											</p>

											<p class="rh_contact__input rh_contact__input_text">
												<label for="email"><?php echo esc_html( $contact_form_email_label ); ?></label>
												<input type="text" name="email" id="email" class="email required" placeholder="<?php esc_attr_e( 'ایمیل شما', 'easy-real-estate' ); ?>" title="<?php esc_attr_e( '* Please provide a valid email address', 'easy-real-estate' ); ?>">
											</p>

											<p class="rh_contact__input rh_contact__input_text">
												<label for="number"><?php echo esc_html( $contact_form_number_label ); ?></label>
												<input type="text" name="number" id="number" placeholder="<?php esc_attr_e( 'شماره تلفون شما', 'easy-real-estate' ); ?>">
											</p>

											<p class="rh_contact__input rh_contact__input_textarea">
												<label for="message"><?php echo esc_html( $contact_form_message_label ); ?></label>
												<textarea cols="40" rows="6" name="message" id="message" class="required" placeholder="<?php esc_attr_e( 'پیام تان', 'easy-real-estate' ); ?>" title="<?php esc_attr_e( '* Please provide your message', 'easy-real-estate' ); ?>"></textarea>
											</p>
											<?php
											...
											<p class="rh_contact__input rh_contact__submit">
												<input type="submit" id="submit-button" value="<?php esc_attr_e( 'Send Message', 'easy-real-estate' ); ?>" class="rh_btn rh_btn--primary" name="submit">
							...
							<div class="rh_contact__details">
								...
								<?php if ( ! empty( $contact_phone ) ) : ?>
									<div class="rh_contact__item">
										...
										<p class="content">
											<span class="label"><?php esc_html_e( 'Phone', 'easy-real-estate' ); ?></span><?php echo esc_html( $contact_phone ); ?>
										</p>
									</div>
								<?php endif; ?>
								...
								<?php if ( ! empty( $contact_cell ) ) : ?>
									<div class="rh_contact__item">
										...
										<p class="content">
											<span class="label"><?php esc_html_e( 'Mobile', 'easy-real-estate' ); ?></span><?php
								...
								<?php if ( ! empty( $contact_fax ) ) : ?>
									<div class="rh_contact__item">
										...
										<p class="content">
											<span class="label"><?php esc_html_e( 'Fax', 'easy-real-estate' ); ?></span><?php
									...
									<div class="rh_contact__item">
										...
										<p class="content">
											<span class="label"><?php
                                                esc_html_e( 'Email', 'easy-real-estate' );
								...
								<?php if ( ! empty( $contact_address ) ) : ?>
									<div class="rh_contact__item">
										...
										<p class="content">
											<span class="label"><?php esc_html_e( 'Address', 'easy-real-estate' ); ?></span><?php echo inspiry_kses( $contact_address ); ?>
										</p>
									</div>
								<?php endif; ?>
