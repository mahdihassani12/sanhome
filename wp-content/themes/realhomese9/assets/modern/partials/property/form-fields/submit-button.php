...
<div class="rh_form__item rh_form--3-column rh_form--columnAlign submit-field-wrapper">
	...
	if ( inspiry_is_edit_property() ) {
		...
		<input type="submit" value="<?php esc_attr_e( 'Update Property', 'easy-real-estate' ); ?>" class="rh_btn rh_btn--primary" />
		<?php

	} else {
	    ?>
		<input type="hidden" name="action" value="add_property"/>
		<input type="submit" value="<?php esc_attr_e( 'Submit Property', 'easy-real-estate' ); ?>" class="rh_btn rh_btn--primary" />
		<?php
	}
	?>
</div>
