...
$terms_note = get_option('inspiry_submit_property_terms_text', esc_html__('قبول همه این شرایط و قوانین.', 'easy-real-estate'));
    ...
    <div class="rh_checkbox rh_checkbox__featured">
        <label for="terms">
            ...
            <input id="terms" name="terms" type="checkbox" class="<?php echo esc_attr($terms_class); ?>"
                   title="<?php esc_attr_e('Please check this option.', 'easy-real-estate'); ?>"
                <?php
            ...
            <span id="terms-error"
                  class="error hide">
                <?php esc_html_e('Please check this option.', 'easy-real-estate'); ?>
            </span>
        </label>
    </div>
    <!-- /.rh_checkbox -->
