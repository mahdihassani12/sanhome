...
if ( inspiry_is_edit_property() ) {
	...
	<div class="rh_form__item rh_form--relative <?php echo esc_attr( $column_class ); ?> rh_form--columnAlign address-map-fields-wrapper">
		...
		<div class="address-wrapper">
			<label for="address"><?php esc_html_e( 'Address', 'easy-real-estate' ); ?></label>
			<input type="text" class="required map-address" name="address" value="<?php echo esc_attr( $property_address ); ?>" title="<?php esc_attr_e( '* Please provide a property address!', 'easy-real-estate' ); ?>" required/>
		</div>
		<!-- /.address-wrapper -->
		<div class="map-wrapper">
			<button class="rh_btn rh_btn--secondary goto-address-button" type="button" value="address"><?php esc_html_e( 'Find Address', 'easy-real-estate' ); ?></button>
	...
	<div class="rh_form__item rh_form--relative <?php echo esc_attr( $column_class ); ?> rh_form--columnAlign address-map-fields-wrapper">
		<div class="address-wrapper">
			<label for="address"><?php esc_html_e( 'Address', 'easy-real-estate' ); ?></label>
			<input type="text" class="required map-address" name="address" value="<?php echo esc_attr( get_option( 'theme_submit_default_address' ) ); ?>" title="<?php esc_attr_e( '* Please provide a property address!', 'easy-real-estate' ); ?>" required/>
		</div>
		<!-- /.address-wrapper -->
		<div class="map-wrapper">
			<button class="rh_btn rh_btn--secondary goto-address-button" type="button"><?php esc_html_e( 'Find Address', 'easy-real-estate' ); ?></button>
			<div class="map-canvas"></div>
