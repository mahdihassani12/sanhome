...
<div class="rh_form__item rh_form--3-column rh_form--columnAlign">
    <label for="type"><?php esc_html_e('Type', 'easy-real-estate'); ?></label>
    <span class="selectwrap">
	    <select name="type"  id="type" class="rh_select2">
            ...
            if (inspiry_is_edit_property()) {
                ...
                ?>
                <!--                <option selected="selected" value="-1">--><?php //esc_html_e( 'نوع ملک تان را انتخاب کنید', 'easy-real-estate' ); ?><!--</option>-->
                <?php
                /**
                 * Property Type Terms
                 */
