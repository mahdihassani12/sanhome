...
if ( $slider_query->have_posts() ) :
									...
									<div class="rh_slide__meta_wrap">
										...
										<?php if ( ! empty( $property_bedrooms ) ) : ?>
											<div class="rh_slide__prop_meta">
												<span class="rh_meta_titles"><?php esc_html_e( 'اتاق خواب', 'framework' ); ?></span>
												<div>
										...
										<?php if ( ! empty( $property_bathrooms ) ) : ?>
											<div class="rh_slide__prop_meta">
												<span class="rh_meta_titles"><?php esc_html_e( 'حمام و دستشوی', 'framework' ); ?></span>
												<div>
										...
										<?php if ( ! empty( $property_size ) ) : ?>
											<div class="rh_slide__prop_meta">
												<span class="rh_meta_titles"><?php esc_html_e( 'مساحت', 'framework' ); ?></span>
												<div>
	...
	?>
	<!-- Slider Placeholder -->
	<section id="rh_slider__home" class="rh_slider hello2 clearfix">
		<div class="flexslider loading">
			<ul class="slides">
				<li>
