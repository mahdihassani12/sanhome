                ...
                <div class="property-count-box">
                    ...
                    if (is_user_logged_in()) {
                        ...
                        if ($my_post_count < $my_post_found) {
                            echo '<h2 class="rh_page__title"><span class="sub">' . $my_post_count . esc_html__(' از ', 'framework') . $my_post_found . '</span><span class="title">' . esc_html__(' لیست املاک', 'framework') . '</span></h2>';
            ...
            if (!is_user_logged_in()) {
                ...
                if (($my_properties_query->have_posts() && 'show' == $my_properties_search) || true == $prop_searched) {
                    ...
                    <div id="my-properties-search-wrap">
                        <form id="my-properties-search" class="clearfix d-flex">
                            <?php
                            $prop_search = '';
                            ...
                            ?>
                            <input type="text" name="prop_search"
                                   placeholder="<?php esc_html_e('Search in your properties', 'framework'); ?>"
                                   value="<?php echo esc_attr($prop_search); ?>">
                            <input type="submit" class="rh_btn--primary"
                                   value="<?php esc_html_e('Search', 'framework'); ?>">
                        </form>
                        <?php
