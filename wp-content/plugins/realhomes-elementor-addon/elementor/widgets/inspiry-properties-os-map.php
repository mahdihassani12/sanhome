...
class RHEA_Properties_OS_Map_Widget extends \Elementor\Widget_Base {
	...
	public function __construct( array $data = [], array $args = null ) {
		...
		add_action( 'wp_ajax_rhea_load_map', [ $this, 'inject_content' ] ); // wp_ajax_{ACTION HERE}
		add_action( 'wp_ajax_nopriv_rhea_load_map', [ $this, 'inject_content' ] );
	}
...
// Sorting
		...
		apply_filters( 'rhea_map_properties_filter', $properties_args );
