...
class RHEA_CTA_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'rows'    => 10,
				'default' => esc_html__( 'Looking to Buy a new property or Sell an existing one? Real Homes provides an easy solution!', 'realhomes-elementor-addon' ),
			]
		);
	...
	protected function render() {
		...
		?>
        <section
                class="rh_section__cta_elementor rh_cta--featured_elementor <?php if ( $settings['ere_enable_parallax_effect'] == 'yes' ) {
