...
//			$default_prop_grid_size = 'agent-image';
		...
		$this->add_control(
			...
			[
				...
				'rows'        => 5,
				'default'     => esc_html__( 'Some amazing features of Real Homes theme.', 'realhomes-elementor-addon' ),
	...
	protected function render() {
		...
		?>
        <div class="rhea_classic_features_section_elementor rhea_class_features_background <?php if ( $settings['ere_enable_parallax_effect'] == 'yes' ) {
