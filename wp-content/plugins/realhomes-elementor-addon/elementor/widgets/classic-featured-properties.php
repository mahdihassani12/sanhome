...
class RHEA_Classic_Featured_Properties_Widget extends \Elementor\Widget_Base {
	...
	protected function render() {
		...
		$featured_properties = new WP_Query( $classic_featured_properties_args );

		?>
        <div class="rhea_classic_featured_properties_elementor">
			<?php
                                        ...
                                        <div class="rhea_detail_side_inner">
                                            ...
                                            <div class="rhea_price_and_button_wrapper">
                                                <div class="rhea_price_side">
                                                    <p class="price"><?php ere_property_price(); ?></p>
                                                    <p class="type"><?php echo ere_get_property_types( get_the_id() ); ?></p>
                                                </div>
