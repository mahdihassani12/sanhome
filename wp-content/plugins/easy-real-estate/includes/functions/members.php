...
if ( ! function_exists( 'ere_new_user_notification' ) ) :
	...
	function ere_new_user_notification( $user_id, $user_password ) {
		...
		$message = apply_filters( 'inspiry_new_user_admin_notification', $message, $user, $user_password );
		...
		$message = apply_filters( 'inspiry_new_user_welcome_notification', $message, $user, $user_password );
