...
if ( ! function_exists( 'ere_agency_rest_api_meta_field' ) ) {

	add_action( 'rest_api_init', 'ere_agency_rest_api_meta_field' );

	function ere_agency_rest_api_meta_field() {
		register_rest_field( 'agency', 'agency_meta', array(
			'get_callback' => 'ere_get_agency_meta_for_rest_api'
		) );
	}

	function ere_get_agency_meta_for_rest_api( $object ) {
		// get the id of the post object array
		$post_id = $object['id'];

		// get post meta
		$agency_post_meta = get_post_meta( $post_id );

		// filter the post meta
		$agency_post_meta = apply_filters( 'ere_agency_rest_api_meta', $agency_post_meta );

		// return the post meta
		return $agency_post_meta;
	}
}