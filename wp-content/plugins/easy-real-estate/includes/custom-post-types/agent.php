...
if ( ! function_exists( 'ere_agent_rest_api_meta_field' ) ) {

	add_action( 'rest_api_init', 'ere_agent_rest_api_meta_field' );

	function ere_agent_rest_api_meta_field() {
		register_rest_field( 'agent', 'agent_meta', array(
			'get_callback' => 'ere_get_agent_meta_for_rest_api'
		) );
	}

	function ere_get_agent_meta_for_rest_api( $object ) {
		// get the id of the post object array
		$post_id = $object['id'];

		// get post meta
		$agent_post_meta = get_post_meta( $post_id );

		// filter the post meta
		$agent_post_meta = apply_filters( 'ere_agent_rest_api_meta', $agent_post_meta );

		// return the post meta
		return $agent_post_meta;
	}
}
