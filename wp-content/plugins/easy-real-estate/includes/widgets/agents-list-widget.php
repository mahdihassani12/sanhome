                            ...
                            <div class="agent-widget-content <?php echo has_post_thumbnail() ? '' : esc_attr('no-agent-thumbnail'); ?>">
								...
								if ( ! empty( $agent_contact_number ) ) : ?>
                                    <div class="agent-contact-number">
                                        <span class="desktop-version"><?php echo esc_html( $agent_contact_number ); ?></span>
                                        <a class="mobile-version"
                                           href="tel://<?php echo esc_url( $agent_contact_number ); ?>"><?php echo esc_html( $agent_contact_number ); ?></a>
                                    </div>
								<?php endif; ?>
                            </div>
                        </article>
