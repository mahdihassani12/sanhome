        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description"><?php printf( esc_html__( 'You can get reCAPTCHA public and private keys for your website by %s signing up here %s', 'easy-real-estate' ), '<a href="https://www.google.com/recaptcha/admin#whyrecaptcha" target="_blank">', '</a>' ); ?></p>
                </td>
            </tr>
            <tr>
