...
$inspiry_property_city_slug    = $this->get_option( 'inspiry_property_city_slug', esc_html__( 'property-city', 'easy-real-estate' ) );
...
<div class="inspiry-ere-page-content">
    ...
    <form method="post" action="" novalidate="novalidate">
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><label for="inspiry_property_city_slug"><?php esc_html_e( 'Property City Slug', 'easy-real-estate' ); ?></label></th>
